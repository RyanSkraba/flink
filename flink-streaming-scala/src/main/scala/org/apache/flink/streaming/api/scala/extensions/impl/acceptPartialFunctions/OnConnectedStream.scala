...
/**
 * Wraps a connected data stream, allowing to use anonymous partial functions to perform extraction
...
class OnConnectedStream[IN1, IN2](stream: ConnectedStreams[IN1, IN2]) {
  ...
  def flatMapWith[R: TypeInformation](
      ...
      flatMap2: IN2 => TraversableOnce[R]): DataStream[R] =
  ...
  def keyingBy[KEY: TypeInformation](
      key1: IN1 => KEY,
      key2: IN2 => KEY): ConnectedStreams[IN1, IN2] =
